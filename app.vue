                      ...
                      <td>
                        <label class="swap">
                          ...
                          <span class="flex items-center space-x-1 swap-on">
                            ...
                            <span v-html="item.organizationId"></span>
                          </span>
                          <span class="flex items-center space-x-1 swap-off">
                            ...
                            <span v-html="organizationHidden(item.organizationId)"></span>
                          </span>
                        </label>
                      </td>
                    </template>
...
function organizationHidden(organization?: string) {
  ...
  return organization.replace(/(org-.{3})(.{6})/g, "$1******");
}
...
async function checkBilling(keyItem: KeyItem, apiUrl: string) {
  ...
  try {
    ...
    if (typeof organizationData.data[1] !== "undefined") {
      keyItem.organizationId = organizationData.data[0].id + "<br/>" + organizationData.data[1].id;
    } else {
